      ...
      <AnimatePresence mode="wait">
        {isSubscribed ? (
          ...
          <motion.button
            ref={ref}
            className={cn(
              "relative flex h-10 w-fit cursor-pointer items-center justify-center rounded-lg border-none bg-primary px-6 text-primary-foreground duration-300 ease-in-out hover:bg-primary/90 animation",
              className,
            )}
            onClick={(e) => {
