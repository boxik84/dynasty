...
export default function NotFound() {
    ...
    return (
        ...
        >
            {/* Animated gradient orbs - Dynasty colors (yellow/orange) */}
            <div className="pointer-events-none absolute left-1/3 top-2/5 z-0 -translate-x-1/2 -translate-y-1/2">
                <motion.div 
                    className="h-[300px] w-[600px] rounded-full bg-[#20c997]/20 blur-3xl"
                    animate={{
                        scale: [1, 1.2, 1],
                        opacity: [0.2, 0.3, 0.2],
                    }}
            ...
            <div className="pointer-events-none absolute left-2/3 top-3/4 z-0 -translate-x-1/2 -translate-y-1/2">
                <motion.div 
                    className="h-[250px] w-[500px] rounded-full bg-[#38d9a9]/15 blur-3xl"
                    animate={{
                        scale: [1, 1.1, 1],
      ...
      <div className="fixed top-1/4 left-1/4 w-72 h-72 bg-[#20c997]/20 rounded-full blur-3xl animate-pulse -z-10" />
      <div className="fixed top-2/3 right-1/3 w-56 h-56 bg-[#38d9a9]/15 rounded-full blur-3xl animate-pulse animation-delay-2000 -z-10" />
      <div className="fixed bottom-1/4 left-1/2 w-64 h-64 bg-[#12a97d]/15 rounded-full blur-3xl animate-pulse animation-delay-4000 -z-10" />

      {/* Floating particles */}
      {Array.from({ length: 15 }).map((_, i) => (
        <div
          key={i}
          className="fixed w-1 h-1 bg-[#20c997]/30 rounded-full animate-pulse -z-10"
          style={{
            top: `${Math.random() * 100}%`,
        ...
        />
            ...
            <div className="relative mx-auto max-w-7xl flex flex-col items-center justify-center z-10">
                ...
                >
                    <div className="absolute inset-0 bg-[#20c997]/20 rounded-full blur-2xl" />
                    <Image
                        src={notFoundImg}
                        alt="404"
                        width={400}
                ...
                >
                    <Link href="/" passHref>
                        <Button
                            size="lg"
                            className="group px-8 py-4 bg-gradient-to-r from-[#20c997] via-[#38d9a9] to-[#12a97d] hover:from-[#38d9a9] hover:to-[#20c997] text-[#141321] font-semibold rounded-xl shadow-xl ring-2 ring-[#20c997]/40 hover:ring-[#38d9a9] transition-all duration-300 cursor-pointer hover:scale-105"
                        >
